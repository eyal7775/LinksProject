...
class YmlFormat(ILinks):
    ...
    def create_library_sources(self):
        ...
        self.file_path = "sources/" + name_source + "/" + name_source + "_md" + str(self.max_depth) + "_" + timestamp + ".yml"
    ...
    def add_data_to_yml(self, link, depth):
        ...
        if depth > self.max_depth:
            ...
            for link in links:
                if not link.split('.')[-1] in ignore:
                    self.add_data_to_yml(link, depth)
